<div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <textarea name="address" rows="3" placeholder="Write your address here...."></textarea>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="weight" min="50" max="105" required>
                </div>

                <div class="input-group">
                    <label>General Health Issues:</label>
                ...
                <div class="input-group">
                    ...
                    <label for="drugs">Drugs intake</label>
                ...
                <div class="input-group">
                    ...
                    <label for="sp">Systolic:</label>
                    <input type="number" name="sp" min="90" max="180">
                    <label for="dp">Diastolic:</label>
                    <input type="number" name="dp" min="50" max="100">
                </div>

                <div class="input-group">
                    <label>Recent Surgery or Major Illness?</label>
                    <input type="radio" name="rsmi" value="yes" required>
                    <label for="yes">Yes</label>
                    <input type="radio" name="rsmi" value="no" required>
                    <label for="no">No</label>
                </div>

                <div class="input-group">
                    <label>Time Between Recent Donations:</label>
                ...
                <div class="input-group">
                    <label>Permanent Diseases:</label>
